...
**Importante:** Registrar la recepción en Compras Verdu **no actualiza el inventario** en ningún otro sistema. La conciliación con stock se hace por otro canal (ver [Recepción e inventario](RECEPCION_Y_STOCK.md)).
...
**Importante:** Los precios de venta guardados aquí son **registro interno**. La carga de precios al sistema de ventas (Tecnolar, caja, etc.) es **manual o la realiza otro sistema** (ver [Precios y ventas](PRECIOS_Y_VENTAS.md)).
...
Para detalles sobre el alcance del sistema (inventario, precios y ventas):

- [Recepción e inventario](RECEPCION_Y_STOCK.md) — La recepción en Compras Verdu no actualiza inventario; la conciliación es por otro canal.
- [Precios y ventas](PRECIOS_Y_VENTAS.md) — Compras Verdu es registro interno; la carga de precios al sistema de ventas es manual u otro sistema.
- [Roles y permisos](ROLES.md) — Configuración de roles y permisos (perspectiva técnica/administrativa).
